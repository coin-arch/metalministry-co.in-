...
if(isset($_POST['submit']))
{
	...
	if(empty($errors))
	{
		//send the email
		/*$to = $your_email;
		$subject="Enquiry Form Details of Stainless Steel 310........";
		$from = $your_email;
		...
		///My Code
		  $to = 'enquiry@metalministry.in';
			...
			$subject = 'Enquiry Form Details of Website - www.metalministry.co.in ';
...
$message .= "<tr style='background: #fff;'><td colspan='2' align='center'><a href='http://www.metalministry.co.in /' target='_blank'>
<img src='http://www.metalministry.co.in/img/logo.png' width='200px'></a>
<a href='http://www.metalministry.co.in/' target='_blank' style='text-decoration:none;'><strong><center>www.metalministry.co.in </center></strong> </a></td></tr>";
$message .= "<tr><td colspan='2' align='center'>&nbsp;</td></tr>";	
$message .= "<tr><td colspan='2' style='text-decoration:none;'>Product Enquiry Details - www.metalministry.co.in </td></tr>";	
...
<form method="POST" name="contact_form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
  <table width="100%" style="border:1px solid #ccc;padding:5%;padding-left:5%;">
    <tr>
     
      <td><input type="text" name="name" placeholder="Name"  class="boxshadow" value='<?php echo htmlentities($name) ?>'></td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr>
      
      <td><input type="text" name="email" placeholder="Email" class="boxshadow" value='<?php echo htmlentities($visitor_email) ?>'></td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr>
     
      <td><input type="text" name="mobile" placeholder="Mobile" class="boxshadow" value='<?php echo htmlentities($visitor_mobile) ?>'></td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr>
      
      <td><textarea name="message" placeholder="Message" class="boxshadow" rows=4 cols=23><?php echo htmlentities($user_message) ?></textarea></td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr>
    ...
    <tr>
      ...
      <td><input id="6_letters_code" placeholder="" name="6_letters_code" class="boxshadow"  type="text"></td>
    </tr>
    <tr>
    ...
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr>
      <td><input type="submit" value="Submit" name='submit' class="setmng"></td>
    </tr>
  </table>
</form>
