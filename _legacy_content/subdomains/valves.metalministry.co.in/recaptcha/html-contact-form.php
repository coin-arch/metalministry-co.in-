	...
	if(empty($errors))
	{
		...
		///My Code
		 $to = 'enquiry@metalministry.in';
			$subject = 'Enquiry Form Details of Website - www.valves.metalministry.co.in';
...
$message .= "<tr style='background: #fff;'><td colspan='2' align='center'><a href='http://valves.metalministry.co.in/' target='_blank'>
<img src='http://www.valves.metalministry.co.in/img/logo.png' width='200px'></a>
<a href='http://valves.metalministry.co.in/' target='_blank' style='text-decoration:none;'><strong><center>www.valves.metalministry.co.in</center></strong> </a></td></tr>";
$message .= "<tr><td colspan='2' align='center'>&nbsp;</td></tr>";	
$message .= "<tr><td colspan='2' style='text-decoration:none;'>Product Enquiry Details - www.valves.metalministry.co.in</td></tr>";	
