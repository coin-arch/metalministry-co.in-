...
if(isset($_POST['submit']))
{
	...
	if(empty($errors))
	{
		...
		///My Code
			...
			$subject = 'Enquiry Form Details of Website - www.nutboltwasher.metalministry.co.in';
		...
		/*	$message = '<html><body>';
			$message .= '<img src="http://champaksteel.com/img/logoc.jpg" alt="Contact Form Details.." />';
			$message .= '<table rules="all" style="border-color: #666; width:80%; margin:0 auto;" cellpadding="10" border="1" >';
			$message .= "<tr style='background: #eee;'><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['name']) . "</td></tr>";
			$message .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['email']) . "</td></tr>";
			$message .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['mobile']) . "</td></tr>";
			$message .= "<tr><td valign='top'><strong>Comment:</strong> </td><td>" . strip_tags($_POST['message']) . "</td></tr>";
			$message .= "</table>";
			$message .= "<br><br><br>";
			$message .= "Thanks & Regards";
			$message .= "<br>";
			$message .= "Champak Steel";
			$message .= "<br><br><br>";
			$message .= "</body></html>";*/
...
$message .= "<tr style='background: #fff;'><td colspan='2' align='center'><a href='http://www.nutboltwasher.metalministry.co.in' target='_blank'>
<img src='http://nutboltwasher.metalministry.co.in/img/logo.png' ></a>
<a href='http://www.nutboltwasher.metalministry.co.in' target='_blank' style='text-decoration:none;'><strong><center>www.nutboltwasher.metalministry.co.in</center></strong> </a></td></tr>";
$message .= "<tr><td colspan='2' align='center'>&nbsp;</td></tr>";	
$message .= "<tr><td colspan='2' style='text-decoration:none;'>Product Enquiry Details - www.nutboltwasher.metalministry.co.in</td></tr>";	
...
<form method="POST" name="contact_form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
  <table width="100%" style="border:1px solid #ccc;padding:5%;padding-left:2%;">
    <tr>
